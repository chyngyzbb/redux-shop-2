...
const ProductCard = ({el}) => {
  ...
  const idf=favorite.some((er)=>er.id===el.id)
  ...
  return (
    <div className="">
      <div className="">
        <div className="w-[300px] h-[400px] mx-4 my-11 flex flex-col justify-between   bg-gray-300 bg-white border border-gray-200 rounded-lg shadow">
          <Zoom>
            <img
              width={250}
              height={250}
